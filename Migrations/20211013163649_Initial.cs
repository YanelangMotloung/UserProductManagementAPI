    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CategoryCode = table.Column<string>(type: "varchar(767)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Imageid = table.Column<string>(type: "varchar(767)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Productcode = table.Column<string>(type: "varchar(767)", nullable: false),
                    Productid = table.Column<int>(type: "int", nullable: false),
                    Name = table.Column<string>(type: "text", nullable: false),
                    Description = table.Column<string>(type: "text", nullable: false),
                    CategoryCode = table.Column<string>(type: "varchar(767)", nullable: false),
                    Price = table.Column<double>(type: "double", nullable: false),
                    ImageId = table.Column<string>(type: "varchar(767)", nullable: true),
                    Createddate = table.Column<DateTime>(type: "datetime", nullable: false),
                    CreatedBy = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
